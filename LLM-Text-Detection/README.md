...
# Model Performance & Accuracy Summary :bar_chart:

| Model Architecture | Training Dataset | Cross-Validation (CV) Accuracy / ROC-AUC | Leaderboard (LB) Score | Notebook / Script |
| :--- | :--- | :--- | :--- | :--- |
| **Model 1: BERT Transformer** (`bert-base-uncased`) | `train_essays.csv` | **99%+ CV Score** | **~0.850** | [`bert-model-for-ai-text-detection.ipynb`](file:///c:/Users/DELL/Desktop/ai/LLM-Text-Detection/bert-model-for-ai-text-detection.ipynb) |
| **Model 2: Voting Classifier** (`LogisticRegression` + `SGD`) | TF-IDF (Base Dataset) | **99%+ CV Score** | **0.932** | [`ensemble-learning-technique-1.ipynb`](file:///c:/Users/DELL/Desktop/ai/LLM-Text-Detection/ensemble-learning-technique-1.ipynb) |
| **Model 3: Hybrid Stacking Ensemble** (`MultinomialNB` + `SGD` + Dual Word/Char TF-IDF) | **All Datasets Combined** (38,248 essays) | **99.63% CV Accuracy** (ROC-AUC: `0.99994`) | **High Robustness** | [`naivebayes-histgradientboosting-model.ipynb`](file:///c:/Users/DELL/Desktop/ai/LLM-Text-Detection/naivebayes-histgradientboosting-model.ipynb) / [`train_third_model.py`](file:///c:/Users/DELL/Desktop/ai/LLM-Text-Detection/train_third_model.py) |
